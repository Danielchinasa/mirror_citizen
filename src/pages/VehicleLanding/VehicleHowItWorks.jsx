    ...
    <HowWrapper id="how-it-works">
      ...
      <StepsRow>
        <StepItem>
          ...
          <StepText>
            <StepName>Choose plate or VIN</StepName>
            <StepDesc>Enter the vehicle's plate number or VIN.</StepDesc>
          </StepText>
        </StepItem>
        <DottedConnector />
        <StepItem>
        ...
        <StepItem>
          ...
          <StepText>
            <StepName>View report</StepName>
            <StepDesc>Get your vehicle report instantly in seconds.</StepDesc>
          </StepText>
        </StepItem>
      </StepsRow>
    </HowWrapper>
...
export default VehicleHowItWorks;
