...
import { FaBuilding, FaCreditCard, FaCheckCircle } from "react-icons/fa";
...
const BusinessHowItWorks = () => {
  return (
    <HowWrapper id="how-it-works">
      <HowHeader>
        <HowLine />
        <HowTitle>How to verify a company</HowTitle>
        <HowLine />
      </HowHeader>
      <StepsRow>
        <StepItem>
          ...
          <StepText>
            <StepName>Enter company details</StepName>
            <StepDesc>Search by company name or RC number.</StepDesc>
          </StepText>
        </StepItem>
        <DottedConnector />
        <StepItem>
        ...
        <StepItem>
          ...
          <StepText>
            ...
            <StepDesc>Get verified company details in seconds.</StepDesc>
          </StepText>
        </StepItem>
      </StepsRow>
    </HowWrapper>
