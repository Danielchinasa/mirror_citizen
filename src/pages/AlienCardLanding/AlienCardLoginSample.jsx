    ...
    <SectionWrapper id="sample-result">
      <TwoColGrid>
        ...
        <SampleCard>
          ...
          <SampleCardSub>
            {isSw
              ? "Tazama mfano wa matokeo ya Kitambulisho cha Taifa."
          ...
          <ResultCard>
            <ResultTop>
              ...
              <ResultGrid>
                ...
                <ResultField>
                  <ResultLabel>
                    {isSw ? "Hali ya Uthibitishaji" : "Verification Status"}
                  </ResultLabel>
                  <VerifiedBadge>
            ...
            <ResultFooter>
              <span>
                {isSw
                  ? "Imethibitishwa tarehe 15 Mei, 2025, 12:45 PM"
                  : "Verified on 15 May, 2025, 12:45 PM"}
              </span>
