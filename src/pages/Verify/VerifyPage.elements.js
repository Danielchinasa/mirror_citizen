  ...
  background: ${(props) =>
    props.active
      ...
      : props.completed
        ...
        : "var(--ec-border)"};
  color: ${(props) =>
    props.active || props.completed ? "#fff" : "var(--ec-text-faint)"};
`;
...
export const StepLabel = styled.span`
  ...
  color: ${(props) =>
    props.active ? "var(--ec-text)" : "var(--ec-text-faint)"};
  white-space: nowrap;
...
export const StepLine = styled.div`
  ...
  height: 2px;
  background: ${(props) =>
    props.completed ? "var(--ec-primary)" : "var(--ec-border)"};
  margin: 0 8px;
...
export const PriceBreakdown = styled.div`
  ...
  margin-bottom: 20px;
  padding-bottom: 16px;
  border-bottom: 1px solid var(--ec-primary);
`;
...
export const PaymentOption = styled.label`
  ...
  transition: border-color 0.2s;
  background: ${(props) =>
    props.selected ? "var(--ec-bg-card-alt)" : "var(--ec-bg-card)"};
