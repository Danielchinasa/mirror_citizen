...
const BusinessName = () => {
  ...
  const renderDetail2 = (label, value) => (
    <>
      <StyledLabel $token={token}> {label}</StyledLabel>
      <StyledLabel $token={token}>
        <strong>{value != null && value !== "null" ? value : "-"}</strong>
      </StyledLabel>
    </>
  ...
  const handleButtonClick = async (cacid) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        if (result.value === "Payment from Wallet") {
        ...
        } else if (result.value === "Instant Payment (Flutterwave)") {
          //!!LIVE PAYMENT START
          ...
          handleCancel();
        } else if (result.value === "Instant Payment (Paystack)") {
  ...
  React.useEffect(() => {
    if (businessData && businessData.length === 1 && businessData != null) {
      ...
      <div style={{ backgroundColor: bgContainer }}>
        <Container $token={token}>
          <InfoSec>
            ...
            >
              <Heading4 $token={token}>Business Verification Result</Heading4>
            </Card>
                  ...
                  items={[
                    {
                      ...
                      label: (
                        <div>
                          ...
                          <RightOutlined /> */}
                          <Text
                            style={{ color: "#02831C", fontWeight: "bold" }}
                          >
                        ...
                        >
                          ...
                          {business["shareholders-data"] == null ? (
                            ...
                            <span style={{ color: "red" }}>
                              <br />
                              We couldn't find any shareholders records based on
