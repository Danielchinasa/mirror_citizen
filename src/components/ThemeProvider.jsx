...
const cssVarsLight = {
  ...
  "--ec-heading": "#354138",
  "--ec-primary": "#02831C",
  "--ec-primary-hover": "#09C93A",
  "--ec-primary-bg": "#dcfce7",
  "--ec-primary-dark": "#02831C",
  "--ec-border": "#e5e7eb",
  "--ec-border-light": "#f0f0f0",
  "--ec-shadow": "rgba(0, 0, 0, 0.06)",
  "--ec-card-hover-shadow": "rgba(0, 0, 0, 0.08)",
  "--ec-hero-gradient":
    "linear-gradient(90deg, #ffffff 0%, #f2fff5 50%, #e9fbe9 100%)",
  "--ec-hero-overlay":
    "linear-gradient(90deg, #ffffff 35%, rgba(255, 255, 255, 0) 100%)",
  "--ec-hero-overlay-mobile":
    "linear-gradient(180deg, #ffffff 0%, rgba(255, 255, 255, 0.78) 46%, rgba(233, 251, 233, 0.72) 100%)",
  "--ec-hero-bottom-gradient":
    "linear-gradient(180deg, rgba(233, 251, 233, 0) 0%, #e9fbe9 100%)",
  "--ec-cta-bg": "#f0fdf4",
  "--ec-cta-shield-bg": "#dcfce7",
  ...
  "--ec-footer-bg": "#354138",
  "--ec-login-bg":
    "linear-gradient(135deg, #f9fafb 0%, #f0fdf4 50%, #dcfce7 100%)",
...
const cssVarsDark = {
  ...
  "--ec-primary-bg": "rgba(9, 201, 58, 0.15)",
  "--ec-primary-dark": "#02831C",
  "--ec-border": "#2e3133",
  ...
  "--ec-cta-bg": "#1e2122",
  "--ec-cta-shield-bg": "rgba(9, 201, 58, 0.15)",
  "--ec-compliance-bg": "#1e2122",
  "--ec-step-bg": "#2a2d2e",
  "--ec-step-card-bg": "#222526",
  "--ec-tag-bg": "rgba(9, 201, 58, 0.15)",
  "--ec-tag-text": "#09C93A",
  "--ec-footer-bg": "#111314",
  "--ec-login-bg":
